...
|---|---|---:|---:|---:|---:|---:|
| full | ground_truth_contains | 0.5000 | 0.4232 | 0.1000 | 0.3333 | 0.1429 |
| chunk200_baseline | ground_truth_contains | 0.5190 | 0.4099 | 0.1000 | 0.3333 | 0.0000 |
...
|---|---:|---:|---:|---:|---:|
| full | 0.75 | 0.2700 | 0.4000 | 0.5000 | 0.5000 |
| chunk200_baseline | 0.80 | 0.5550 | 0.6000 | 0.7500 | 0.2500 |

## Decision Gate

| variant | gate_passed | rules_passed | rules_total | failed_rules |
|---|---|---:|---:|---|
| full | False | 4 | 7 | calibration:max_ece;calibration:min_accepted_accuracy_proxy;calibration:max_error_leakage_rate_after_accept |
| chunk200_baseline | False | 3 | 8 | metric_min:faithfulness;calibration:max_ece;calibration:min_accepted_accuracy_proxy;calibration:max_error_leakage_rate_after_accept;significant_improve:faithfulness |
